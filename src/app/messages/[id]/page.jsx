...
export default function AdopterChatPage({ params }) {
  ...
  useEffect(() => {
    async function loadChat() {
      ...
      // Fetch conversation with pet and shelter info
      const { data: convo, error: convoError } = await supabase
        .from('conversations')
        .select('*, pet:pets(id, name, photos), shelter:shelters(name, email, phone)')
